...
# 1.- Permitir que los usuarios creen sus propios usuarios para poder iniciar nuevas sesiones. El programa debe acceder a los registros del usuario si existe y permitirle las siguientes opciones de edición:
...
print("")
print("Ingresa '1' para iniciar sesión en tu cuenta")
print("O bien ingresa '2' si aún no tienes una cuenta")

enter = int(input("¿Qué deseas hacer?: "))
